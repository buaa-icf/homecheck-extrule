...
<body>
  <main>
    ...
    <section class="panel table-panel"><h2 class="table-title">仓库共享资源</h2><div class="table-scroll"><table><thead><tr><th>仓库</th><th>规则</th><th>状态</th><th class="num">.ets/.ts 代码行数</th><th class="num">预处理耗时 (s)<div style="font-size:11px;font-weight:400">进程启动 + Scene 构建等共享开销</div></th><th class="num">分析耗时 (s)<div style="font-size:11px;font-weight:400">全部选中规则合计</div></th><th class="num">峰值 RSS (MB)</th></tr></thead><tbody id="repositoriesBody"></tbody></table></div></section>
